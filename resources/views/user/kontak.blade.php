...
<div class="site-section">
                ...
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2">
                        <p style="font-family: 'Butler'; font-weight: bold; font-style: normal; color:brown">
                            <font size="6">UNIK DAN NATURAL</font>
                        </p>
                    </h1><br>
                    <div class="intro-text text-center text-md-left">
                        <p class="mb-4" style="font-family: 'Young'; font-weight: 300; font-style: normal; color:brown">Seluruh produk woodenware kami terbuat dari bahan kayu jati alami, dihadirkan
    ...
    <div class="container">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-12 col-lg-5 text-center pl-md-5">
                        <h2 style="font-family: 'Butler'; font-weight: bold; font-style: normal; color:brown">
                            <font size="6">SEDIKIT CERITA TENTANG KAYU JATI</font>
                        </h2>
                        <br>
                    ...
                    <div class="col-md-12 col-lg-7 mb-5">
                        <a href="#"><img src="images/about/DSC03073.JPG" alt="Image placeholder" class="img-fluid rounded" data-pagespeed-url-hash="2922651310" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="images/about/DSC03858.JPG" alt="Image placeholder" class="img-fluid rounded" data-pagespeed-url-hash="2922651310" onload="pagespeed.CriticalImages.checkImageForCriticality(this);"></a>
                </div>
                <div class="col-md-12 col-lg-5 text-center pl-md-5">
                    <h2 style="font-family: 'Butler'; font-weight: bold; font-style: normal; color:brown">
                        <font size="6">BAGAIMANA KAYU JATI BISA AMAN DIGUNAKAN?</font>
                    </h2>
                    <br>
                    <p align="justify" style="font-family: 'Young'; font-weight: 300; font-style: normal; color: brown">
    ...
    <div class="site-section">
        <div class="site-blocks-cover aos-init aos-animate" style="background-image: url(images/about/DSC03721.JPG);" width="1500" data-aos="fade" </div>

            <div class="top-left" style="font-family: 'Young'; font-weight: bold; font-style: normal; color: #FDD695">
                <font size="6">AYO DUKUNG PRODUK LOKAL</font>
            </div>
            <div class="top-right" style="font-family: 'Young'; font-weight: 800; font-style: normal; color: #FDD695">
                <font size="5">
            ...
            <div class="top-right2" style="font-family: 'Young'; font-weight: 800; font-style: normal; color: #FDD695">
                <font size="4">
